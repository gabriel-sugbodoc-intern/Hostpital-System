...
export default function DoctorDashboard() {
  ...
  if (!data) {
    return (
      <div className="py-16 text-center text-sm text-muted-foreground">Dashboard unavailable.</div>
    );
  }
  ...
  const stats = [
    {
      ...
      value: data.summary.assignedPatients,
      icon: Users,
      to: "/doctor/patients",
    },
    {
    ...
    {
      label: "Encounters",
      value: data.summary.encounters,
      icon: HeartPulse,
      to: "/doctor/encounters",
    },
    {
      label: "Waiting in Queue",
      value: data.summary.waitingInQueue,
      icon: ListOrdered,
      to: "/doctor/patients",
    },
  ] as const;
