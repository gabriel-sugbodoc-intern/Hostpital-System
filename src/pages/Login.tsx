...
export default function Login({ initialMode = 'login' }: { initialMode?: Mode } = {}) {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.debug('[auth-debug] ui: apiClient.login settled', { hasError: !!error, hasData: !!data });
      if (error) {
        toast.error(error);
        return;
      }
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.debug('[auth-debug] ui: apiClient.register settled', { hasError: !!error, hasData: !!data });
      if (error) {
        toast.error(error);
        return;
      }
